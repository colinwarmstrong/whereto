...
describe 'City API Endpoints' do
  context 'GET /api/v1/cities' do
    it 'returns data about all cities in the database' do
      ...
      expect(city_1[:growth]).to eq((chicago.growth.to_f / 100.to_f).round(2))
      ...
      expect(city_2[:growth]).to eq((denver.growth.to_f / 100.to_f).round(2))
  ...
  context 'GET /api/v1/cities/:id' do
    it 'returns data about a specific city in the database' do
      ...
      expect(city[:growth]).to eq((denver.growth.to_f / 100.to_f).round(2))
  ...
  context 'GET /api/v1/cities?state=:state_name' do
    it 'returns data about all cities for a specific state' do
      ...
      expect(city_1[:growth]).to eq((denver.growth.to_f / 100.to_f).round(2))
      ...
      expect(city_2[:growth]).to eq((boulder.growth.to_f / 100.to_f).round(2))
  ...
  context 'GET /api/v1/cities?sort=population' do
    it 'returns data about all cities sorted by population' do
      ...
      expect(city_3[:growth]).to eq((boulder.growth.to_f / 100.to_f).round(2))
  ...
  context 'GET /api/v1/cities?sort=alphabetical' do
    it 'returns data about all cities sorted by population' do
      ...
      expect(city_1[:growth]).to eq((boulder.growth.to_f / 100.to_f).round(2))
      ...
      expect(city_2[:growth]).to eq((chicago.growth.to_f / 100.to_f).round(2))
      ...
      expect(city_3[:growth]).to eq((denver.growth.to_f / 100.to_f).round(2))
  ...
  context 'GET /api/v1/cities?sort=state' do
    it 'returns data about all cities sorted by alphabetical state names' do
      ...
      expect(city_3[:growth]).to eq((chicago.growth.to_f / 100.to_f).round(2))
      ...
      expect(city_4[:growth]).to eq((seattle.growth.to_f / 100.to_f).round(2))
  ...
  context 'GET /api/v1/cities?sort=growth' do
    it 'returns data about all cities sorted by growth' do
      denver  = City.create(name: 'Denver', state: 'Colorado', rank: 12, growth: '5.7', population: 2345127, latitude: '49.8781136', longitude: '-82.6297982')
      boulder = City.create(name: 'Boulder', state: 'Colorado', rank: 22, growth: '6.7', population: 1223456, latitude: '50.8781136', longitude: '-81.6297982')
      chicago = City.create(name: 'Chicago', state: 'Illinois', rank: 3, growth: '7.7', population: 3239845, latitude: '51.8781136', longitude: '-83.6297982')

      get "/api/v1/cities?sort=growth"
