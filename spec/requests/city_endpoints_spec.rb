...
describe 'City API Endpoints' do
  ...
  context 'GET /api/v1/cities/:id?state=:state_name' do
    it 'returns data about all cities for a specific state' do
      ...
      chicago = City.create(name: 'Chiacgo', state: 'Illinois', rank: 3, growth: '7.7', population: 339845, latitude: '51.8781136', longitude: '-83.6297982')
